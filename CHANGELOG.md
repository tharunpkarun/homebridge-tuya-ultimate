...
### Fixed
 ...
 - Retry Tuya error `1109` from compatible virtual IR air conditioners through the physical MOES-style IR thermostat datapoints exposed by the QR account API.
